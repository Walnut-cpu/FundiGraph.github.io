# FundiGraph
FundiGraph is a retinal disease knowledge graph constructed based on a large language model, covering 13 categories and 739 types of retinal diseases, including both common and rare ones. 
